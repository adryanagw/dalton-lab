...
const subjectsData = {
  ...
  kimia: {
    ...
    babs:[
      ...
      {id:'bab2-struktur-atom-sistem-periodik', num:'Bab 2', title:'Struktur Atom & Sistem Periodik Unsur', desc:'Partikel sub-atomik, notasi nuklida, konfigurasi elektron kuantum, hingga tabel periodik dan tren keperiodikan.', ready:true, estMinutes:20, subbabCount:8},
    ]
  },
  fisika: {
